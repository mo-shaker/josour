...
{
    private static readonly AppSettings Settings = new() { ServerUrl = "https://josour.example.com" };
    ...
    public void ItCarriesWhatSupportAsksFor()
    {
        ...
        Assert.Equal("https://josour.example.com", info.ServerUrl);
    ...
    public void SignedOut_ShowsEmptyIdentityFields_RatherThanStaleOnes()
    {
        ...
        Assert.Equal(Josour.Infrastructure.Logging.LoggingSetup.DefaultLogDirectory, info.LogDirectory);
    }
