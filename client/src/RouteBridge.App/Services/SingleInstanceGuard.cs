...
{
    public const string MutexName = @"Global\RouteBridge.SingleInstance";
    public const string ShowWindowEventName = @"Global\RouteBridge.ShowWindow";
    ...
    public void StartListening()
    {
        ...
        {
            IsBackground = true,
            Name = "RouteBridge.ShowWindowListener",
        };
        _listener.Start();
    }
