...
namespace RouteBridge.Tunnel.Certificates;

/// <summary>
/// شهادة ذاتية مؤقتة لجلسة واحدة (docs/protocol.md القسم 2 الخطوة 1):
/// ECDSA P-256، CN=routebridge، EKU serverAuth+clientAuth، الصلاحية من الآن − 5 دقائق إلى expires_at + ساعة.
...
{
    public const string SubjectName = "CN=routebridge";
