...
/// التنفيذ الحقيقي <c>Josour.Egress.EgressTunnelAdapter</c>؛ يُحقن كمصنع لأن Egress يعتمد على Tunnel لا العكس.
/// </summary>
...
/// <summary>
/// جانب Guest: Proxy محلي فوق النفق. التنفيذ الحقيقي <c>Josour.Proxy.ProxyTunnelAdapter</c>
