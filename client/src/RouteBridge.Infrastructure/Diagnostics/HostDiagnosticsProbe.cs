...
/// <see cref="FirewallDiagnostics"/> in <c>RouteBridge.Core</c> because this class and track B's
/// <c>RouteBridge.Tunnel.Diagnostics.HostDiagnostics</c> both shelled out to netsh with slightly different arguments and
