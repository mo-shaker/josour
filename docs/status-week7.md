...
2. **قائمة القبول الـ 18** — [مُلئت من السجلات](acceptance-checklist.md): **5 محققة، 5 جزئية، 7 لم تُختبر، وبند واحد يحتاج إعادة صياغة**. سبعة منها تُغلق بجولة يدوية لا تتجاوز عشر دقائق على الجهازين.
