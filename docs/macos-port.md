...
| 6 | **فحص مالك الاتصال** | `iphlpapi!GetExtendedTcpTable` | `libproc` + مجموعة عمليات المتصفح | ⬜ **ضابط أمني — انظر أدناه** |
...
وتبقى `RejectUnknownOwner` كما هي: حين يتعذّر التعرّف يُرفض، لا يُقبل.
